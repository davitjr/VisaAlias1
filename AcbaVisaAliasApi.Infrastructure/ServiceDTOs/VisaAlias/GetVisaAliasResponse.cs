...
{
    public class GetVisaAliasResponse
    {
        /// <summary>
        ...
        public List<OneVisaAlias> Aliases { get; set; }

        public class OneVisaAlias
        {
            /// <summary>
            /// This attribute contains the alias data, e.g. phone number, email address, etc.,
            /// If phone number is used for alias, this should be provided in accordance with ITU-T E.164 (2010) 
            ...
            /// <summary>
            /// This attributes contains whether or not this is the default account to receive money.
            /// </summary>
